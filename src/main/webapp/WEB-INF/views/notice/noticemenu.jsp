...
<section class="title">
    ...
    <div class="navbar" id="cssmenu" >
    	<ul class="nav" style="text-align:center; margin-bottom:15px;">
            ...
            <li><a id="chat" href=""><img src="${pageContext.request.contextPath}/resources/images/customerCenter/chat.png" alt="" style=" width:30px; height:30px; padding-bottom: 11px" /><div>실시간상담</div></a></li>
        </ul>        
	</div>
</div>
<script>
	$(function(){
		$("#chat").click(function(){
			...
			$(this).attr('href','${pageContext.request.contextPath}/consulting.do');
